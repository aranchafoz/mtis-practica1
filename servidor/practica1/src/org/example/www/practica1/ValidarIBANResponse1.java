 ...
 */
            ...
            /**
            *  ValidarIBANResponse1 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ValidarIBANResponse1
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://www.example.org/practica1/",
                "validarIBANResponse1",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":validarIBANResponse1",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "validarIBANResponse1",
    ...
    public static class Factory{
        ...
        */
        public static ValidarIBANResponse1 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ValidarIBANResponse1 object =
                new ValidarIBANResponse1();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"validarIBANResponse1".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ValidarIBANResponse1)org.example.www.practica1.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
